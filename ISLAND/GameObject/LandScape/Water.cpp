...
void Water::CreateMesh()
{
	...
	vertices[1].position = Float3(0.0f, 0.0f, radius * 2.0f);
	vertices[2].position = Float3(radius * 2.0f, 0.0f, 0.0f);
	vertices[3].position = Float3(radius * 2.0f, 0.0f, radius * 2.0f);
