...
QuadTree::QuadTree(TerrainData* terrainData)
    : drawCount(0)
{
...
void QuadTree::CalcMeshDimensions(UINT vertexCount, float& centerX, float& centerZ, float& width)
{
