...
PixelOutput main(PixelInput input)
{
    ...
    for (int i = 0; i < sampleCount; i++)
    {
        ...
        float2 opticalDepthP = sunOpticalDepth + viewerOpticalDepth;
