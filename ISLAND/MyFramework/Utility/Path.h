...
public:
	...
	const static WCHAR* TileMapDataFilter;
	const static WCHAR* SpriteInfoFilter;
	const static WCHAR* SpriteFilter;
	...
	static void SaveFileDialogWithoutExtension(wstring file, const WCHAR* filter, wstring folder, function<void(wstring)> func, wstring ext, HWND hWnd = NULL);
