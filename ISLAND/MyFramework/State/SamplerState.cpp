...
void SamplerState::AddressU(D3D11_TEXTURE_ADDRESS_MODE value)
{
	desc.AddressU = value;
	Changed();
}

void SamplerState::AddressV(D3D11_TEXTURE_ADDRESS_MODE value)
{
	desc.AddressV = value;
	Changed();
}

void SamplerState::AddressW(D3D11_TEXTURE_ADDRESS_MODE value)
{
	desc.AddressW = value;
	Changed();
}
